...
__DEVICE__ float2 draw_digits_int(int p_Width, int p_Height, int p_X, int p_Y, float3 *rgb, float drawing_value, int2 g_st_pos, int r_height, int r_width, float3 *font_color)
{
    int ii;
