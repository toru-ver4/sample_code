    ...
    control_layout_frame = sg.Frame(
        ...
        [[sg.Text("HDR Reference White Liminance:", size=PARAM_TEXT_SIZE,
         ...
         [sg.Text("Alpha:", size=PARAM_TEXT_SIZE, justification='r'),
          sg.Spin([size/100 for size in range(0, 33)], initial_value=0.05,
          ...
          default_value=0.05, resolution=0.01)],
         [sg.Text("Sigma:", size=PARAM_TEXT_SIZE, justification='r'),
          sg.Spin([size/100 for size in range(0, 100)], initial_value=0.75,
          ...
          default_value=0.75, resolution=0.01)],
         [sg.Text("k1:", size=PARAM_TEXT_SIZE, justification='r'),
          sg.Spin([size/100 for size in range(10, 100)], initial_value=0.51,
          ...
          default_value=0.51, resolution=0.01)],
         [sg.Text("k3:", size=PARAM_TEXT_SIZE, justification='r'),
          sg.Spin([size/100 for size in range(10, 100)], initial_value=0.75,
         ...
         [sg.Text("SDR Inflection Point:", size=PARAM_TEXT_SIZE,
          justification='r'),
          sg.Spin([size/10 for size in range(200, 1000)], initial_value=51.1,
          ...
          default_value=51.1, resolution=0.1)],
