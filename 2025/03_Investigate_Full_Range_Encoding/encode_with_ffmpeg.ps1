...
ffmpeg -loop 1 -color_primaries bt709 -color_trc bt709 -colorspace bt709 -r 24 -i ".\img\src_img.png" -t 1 `
    ...
    -color_primaries bt709 -color_trc bt709 -colorspace bt709 "encode_data\FFmpeg\H265_MOV_Main10_Full\H265_MOV_Main10_Full.mov" -y

ffmpeg -loop 1 -color_primaries bt709 -color_trc bt709 -colorspace bt709 -r 24 -i ".\img\src_img.png" -t 1 `
    -c:v libx265 -x265-params "lossless=1:range=limited" -pix_fmt yuv422p10le -tag:v hvc1 -an `
