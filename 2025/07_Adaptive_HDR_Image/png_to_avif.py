...
scale_factor = 2  # nearest neighbor
...
if __name__ == '__main__':
    ...
    # )
    # png_to_avif_2(
    #     png_fname="./src_img/1920x1080_sRGB_Rec.2020_0.5x.png",
    #     avif_fname="./src_img/1920x1080_sRGB_Rec.2020_0.5x.avif",
    ...
    # img = tpg.img_read_as_float("./src_img/kanazawa_castle_01_BT2100-PQ.png")
    # img = img[::scale_factor, ::scale_factor]
    # tpg.img_wirte_float_as_16bit_int("./src_img/kanazawa_castle_01_BT2100-PQ_2K.png", img)
    # png_to_avif_2(
    #     png_fname="./src_img/kanazawa_castle_01_BT2100-PQ_2K.png",
    #     avif_fname="./src_img/kanazawa_castle_01_BT2100-PQ_2K.avif",
    #     color_space_name=cs.BT2020,
    #     transfer_characteristics=tf.ST2084,
    # )
    # png_to_avif_2(
    #     png_fname="./src_img/kanazawa_castle_01_BT2100-PQ_2K.png",
    #     avif_fname="./src_img/kanazawa_castle_01_BT2100-PQ_2K_lossy.avif",
    #     color_space_name=cs.BT2020,
    #     transfer_characteristics=tf.ST2084,
    #     lossless=False
    # )
    # img = tpg.img_read_as_float("./src_img/kanazawa_castle_01_sRGB.png")
    # img = img[::scale_factor, ::scale_factor]
    # tpg.img_wirte_float_as_16bit_int("./src_img/kanazawa_castle_01_sRGB_2K.png", img)
    # png_to_avif_2(
    #     png_fname="./src_img/kanazawa_castle_01_sRGB_2K.png",
    #     avif_fname="./src_img/kanazawa_castle_01_sRGB_2K.avif",
    #     color_space_name=cs.BT709,
    #     transfer_characteristics=tf.SRGB,
    # )
    # png_to_avif_2(
    #     png_fname="./src_img/kanazawa_castle_01_sRGB_2K.png",
    #     avif_fname="./src_img/kanazawa_castle_01_sRGB_2K_lossy.avif",
    #     color_space_name=cs.BT709,
    #     transfer_characteristics=tf.SRGB,
    #     lossless=False
    # )
    ...
    # img = img[::scale_factor, ::scale_factor]
    # tpg.img_wirte_float_as_16bit_int("./src_img/kenrokuen_01_BT2100-PQ_2K.png", img)
    # png_to_avif_2(
    #     png_fname="./src_img/kenrokuen_01_BT2100-PQ_2K.png",
    #     avif_fname="./src_img/kenrokuen_01_BT2100-PQ_2K.avif",
    #     color_space_name=cs.BT2020,
    #     transfer_characteristics=tf.ST2084,
    #     lossless=False
    # )
    ...
    #     transfer_characteristics=tf.ST2084,
    # )
    # img = tpg.img_read_as_float("./src_img/kenrokuen_01_sRGB.png")
    # img = img[::scale_factor, ::scale_factor]
    # tpg.img_wirte_float_as_16bit_int("./src_img/kenrokuen_01_sRGB_2K.png", img)
    # png_to_avif_2(
    #     png_fname="./src_img/kenrokuen_01_sRGB_2K.png",
