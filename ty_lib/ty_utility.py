...
def search_specific_extension_files(dir, ext=".edr"):
    """
    [Generated by ChatGPT]
    Searches for files with a specific extension within a given directory, 
    and returns a list of these files.
    ...
    ext : str, optional
        The file extension to search for (default is ".edr").
    ...
    Examples
    --------
    >>> search_specific_extension_files(dir="./edr")
    [WindowsPath('edr/file1.edr'), WindowsPath('edr/file2.edr'), ...]

    >>> search_specific_extension_files(dir="./data", ext=".txt")
